...
(function () {
	...
	extend(ConnectorManager.prototype, {
		...
		return request(this.hoist._configs, { url: this.url + "/disconnect" }, success, error, context );
	    },
	    removeFromUser: function(success, error, context) {
		return request(this.hoist._configs, { url: this.url + "/removeFromUser" }, success, error, context );
	    },
